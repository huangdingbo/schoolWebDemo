    ...
    export default {
        ...
        methods: {
            refresh(){
                ...
                this.$api.statistical({type:2,studentType:this.studentType,grade:this.grade,testNum:this.testVal,class:this.classVal}).then(res => {
                    this.list = res.list;
                });
                this.$api.warningdevelop({type:2,studentType:this.studentType,grade:this.grade,testNum:this.testVal,class:this.classVal}).then(res => {
